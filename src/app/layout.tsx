...
import { Home, Bot, Settings, ShieldCheck, Users, Wrench, ShieldAlert } from 'lucide-react';
...
function AppLayout({
  ...
  const allNavItems = [
    ...
    { href: '/breach-monitoring', label: 'Breach Monitoring', icon: ShieldAlert, roles: ['admin', 'guest'] },
